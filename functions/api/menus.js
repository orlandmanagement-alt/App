...
export async function onRequestPost({ env, data, request }){
  ...
  await audit(env,{ actor_user_id:sess.uid, action:"menu.create", target_type:"menu", target_id:id, meta:{ code, path }});
...
export async function onRequestPut({ env, data, request }){
  ...
  await audit(env,{ actor_user_id:sess.uid, action:"menu.update", target_type:"menu", target_id:id, meta:{ code, path }});
...
export async function onRequestDelete({ env, data, request }){
  ...
  await audit(env,{ actor_user_id:sess.uid, action:"menu.delete", target_type:"menu", target_id:id, meta:{}});
